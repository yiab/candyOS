...
#!/bin/bash
arm-linux-gnueabihf-gcc-real --sysroot=/home/baiyun/git/ckOS/dist/pi/sdk -isystem =/include \$MY_TOOLCHAIN_FLAGS "\$@" <&0
_EOF_
            chmod +x $MY_TARGET-gcc

            cat << _EOF_ > $MY_TARGET-g++
#!/bin/bash
arm-linux-gnueabihf-g++-real --sysroot=/home/baiyun/git/ckOS/dist/pi/sdk -isystem =/include \$MY_TOOLCHAIN_FLAGS "\$@" <&0
_EOF_
            chmod +x $MY_TARGET-g++
